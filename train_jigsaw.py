...
class Trainer:
    ...
    def _do_epoch(self):
        ...
        for it, ((data, jig_l, class_l), d_idx) in enumerate(self.source_loader):
            ...
            # pool2d = torch.nn.AdaptiveAvgPool2d(output_size=(75,75))
            # torchvision.utils.save_image(pool2d(data).data, 'test.png')
            # torchvision.utils.save_image(data.data, 'test2.png')
            # print('printed')
            # break
