...
officehome_datasets = ["art_pada", "clipart_pada", "product_pada", "realworld_pada"]
digits_datasets = [mnist, mnist, svhn, usps]
available_datasets = office_datasets + officehome_datasets + pacs_datasets + vlcs_datasets + digits_datasets
